...
internal class CustomCoachMarkContentView: UIView, CoachMarkContent {
    // MARK: - Internal properties | CoachMarkContent
    ...
    private func setupInnerViewHierarchy() {
        ...
        self.nextButton.setBackgroundImage(UIImage(named: "button-background"), for: .normal)
        self.nextButton.setBackgroundImage(
            UIImage(named: "button-background-highlighted"),
            for: .highlighted
        )
