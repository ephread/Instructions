...
public class DefaultCoachMarkContentView: UIControl,
                                          CoachMarkContent {
    ...
    public var background: CoachMarkContentBackgroundStyle {
    ...
    private var bodyBackground = CoachMarkContentBackgroundView().preparedForAutoLayout()
...
private extension DefaultCoachMarkContentView {
    func initializeViewHierarchy() {
        ...
        labelStackView.fillSuperview(insets: insets)
        ...
        separator.heightAnchor.constraint(
            equalTo: labelStackView.heightAnchor,
            constant: -10
        ).isActive = true
    }
