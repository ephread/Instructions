...
public class DefaultCoachMarkSkipperView: UIButton,
                                          TutorialSkipper {
    ...
    public override var isHighlighted: Bool {
        didSet { bodyBackground.isHighlighted = isHighlighted }
    }

    public var background: CoachMarkContentBackgroundStyle { return bodyBackground }
    public var isStyledByInstructions = true {
        didSet { bodyBackground.isHidden = !isStyledByInstructions }
    }

    // MARK: Private properties
    private var bodyBackground = CoachMarkContentBackgroundView()
